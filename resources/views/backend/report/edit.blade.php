...
@section('content')
    ...
    <div class="container-fluid pt-4x px-4x p-0">
        <div class="bg-light text-start rounded p-4">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Edit Dashboard</h6>
            ...
            <div class="bg-light rounded h-100 p-4x">
                <form action="{{ route('dashboard.update', $dashboard->id) }}" class="form-horizontal" enctype="multipart/form-data"
                    method="post">
                    @csrf
                    @method('put')
                    <div class="bg-light rounded h-100 p-4x">
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-12">
                                                        ...
                                                        <textarea class="form-control" name="description" id="editor1">{{ $dashboard->description }}</textarea>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapseOnel" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                            ...
                            <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                ...
                                <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapseOnem" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-md-12 d-none showaddbtn" style="width: 100%">
                                                            ...
                                                            <div class="mb-3 text-start">
                                                                ...
                                                                <div id="mdi"
                                                                    ...
                                                                    @foreach ($groups as $item)
                                                                        {{-- {{dd($selectedgroups, $groups)}} --}}
                                                                        @if ($selectedgroups != null && in_array($item->id, $selectedgroups, true))
                                                                            <span><input
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="groupids[]" id=""
                                                                    ...
                                                                    @foreach ($selectedgroupsdata as $item)
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3 text-start">
                                                                <label for="filter"
                                                                    class="form-label">Users&nbsp;</label><input
                                                                    id="filter" type="text"
                                                                    class="filter form-control"
                                                                    placeholder="Search Groups">
                                                                <br />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="userids[]" id=""
                                                                    class="form-control" multiple>
                                                                    @foreach ($selecteduserdata as $item)
                                                                        <option value="{{ $item->id }}"
                                                                            id="{{ $item->name }}" selected>
                                                                            {{ $item->name }}
                                                                        </option >
    ...
    <script>
        ...
        var currentlayout = document.getElementsByName('layout')[0];
        for (let index = 0; index < currentlayout.length; index++) {
            if (currentlayout[index].value == layout) {
                currentlayout[index].selected = true;
            }
        }

        var radioselected = "{{ $dashboard->access }}";
