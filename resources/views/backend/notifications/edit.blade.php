    ...
    <div class="bg-light rounded h-100 p-4">
      ...
      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
          ...
          <form action="{{ route('notifications.update', $notification->id) }}" class="form-horizontal" method="post">
            @csrf
            @method('PUT')

            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Name</label>
              <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{$notification->name}}" aria-describedby="namehelp" required>
              @error('name')
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('type') is-invalid @enderror" name="type" value="{{$notification->type}}" id="type" aria-describedby="namehelp">
              @error('type')
              ...
              <div class="mb-3">
                ...
                <div class="usergrouplist">
                  ...
                  <div class="col-md-12 d-flex justify-content-between">
                    ...
                    <div class="col-md-4">
                      <select id="" class="form-control " multiple disabled>
                        @foreach ($selectedapplications as $item)
                        <option selected>
                          {{ $item->name }}
                        </option>
                        @endforeach
